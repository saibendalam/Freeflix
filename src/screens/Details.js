 ...
 getdata=()=>{
   ...
   if(this.state.language.indexOf("all") !== -1 && this.state.language.indexOf("all") !== -1  ){
    this.setState({
     ...
     console.log('https://api.freeflix.in/public/live-streams')
    ...
    .then((responseJSON) => {
      console.log(responseJSON.result.list[1].youtube_id)
      this.setState({
   ...
   if(this.state.language.indexOf("all") !== -1 && this.state.categories.indexOf("all") == -1 ){
    this.setState({
     ...
     console.log('categories not all')
     console.log('https://api.freeflix.in/public/live-streams?skip=0&total=true&categories='+this.state.categories.join(','))
           fetch('https://api.freeflix.in/public/live-streams?skip=0&total=true&categories='+this.state.categories.join(','))
    .then((cresponse) => {
    ...
    .then((cresponseJSON) => {
      ...
      console.log(cresponseJSON.result.list)
      this.setState({
  ...
  render() {
    ...
    useEffect(() => {
        ...
        if (Object.keys(item).length === 0) {
            console.log(navigation.getParam('userId', 1))
         vid = navigation.getParam('userId', 1)
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRightt}>
            <View style={{ paddingRight: 25 }}>
              <Text onPress={()=>{
                Linking.openURL('https://freeflix.live/')
              }} style={{ color: 'white', textAlign: 'center' }}>freeflix.media</Text>
            </View>
